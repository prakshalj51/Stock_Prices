...
dataset = pd.read_csv('YESBANK.NS.csv')
...
plt.plot(real_stock_price, color = 'red', label = 'Real Yes Bank Stock Price (2018)')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted Yes Bank Stock Price(2018)')
...
regressor.save('model_yesbank.h5')
