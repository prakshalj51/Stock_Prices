...
plt.plot(real_stock_price, color = 'red', label = 'Real Wipro Stock Price (2018)')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted Wipro Stock Price(2018)')
