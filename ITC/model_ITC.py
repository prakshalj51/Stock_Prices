...
dataset = pd.read_csv('ITC.NS.csv')
...
plt.plot(real_stock_price, color = 'red', label = 'Real ITC Stock Price (2018)')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted ITC Stock Price(2018)')
